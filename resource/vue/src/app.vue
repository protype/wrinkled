        ...
        <div class="container-fluid">
            ...
            <div class="col-12 col-md-10">
              ...
              <div class="input-group input-group-lg mt-5">
                ...
                <div class="input-group-append">
                  <button type="button" @click="shorten" class="btn-lg btn-secondary ml-3">Shorten</button>
                </div>
              </div>
          ...
          <div class="options-panel collapse row justify-content-center mt-5">
            <div class="col-11 text-left shadow-sm p-5 bg-light rounded position-relative">
              ...
              <button class="btn btn-secondary btn-lg btn-block mt-4" @click="update" :disabled="action.id == 0">Save</button>
